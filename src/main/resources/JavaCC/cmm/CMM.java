...
if (jjtc000) {
  ...
  static final public void MyInteger() throws ParseException {/*@bgen(jjtree) MyInteger */
...
if (jjtc000) {
  ...
  static final public void MyReal() throws ParseException {/*@bgen(jjtree) MyReal */
